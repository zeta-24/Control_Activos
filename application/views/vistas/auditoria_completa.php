...
<div class="panel panel-primary">
    ...
    <div class="form-group">
        <span>
            ...
            <textarea id="txtComentario" class="form-control" rows="3" disabled="true"><?php echo $comentario ?></textarea>
    ...
    <div class="form-group">
        ...
        <span>
            ...
            <button  type="submit" class="btn btn-primary" onclick="borrarAuditoria(<?php echo $this->session->userdata('idAuditoria')?>)" disabled="true">Cancelar</button>
